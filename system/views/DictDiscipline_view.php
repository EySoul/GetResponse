...
<table class="table table-bordered">
  ...
  <tr>
      <?php foreach($value as $name => $field):?>
        ...
        <?php if($name == 'dictDisciplineExternalId') $id = $field;?>

        <?php if($name == 'dictDisciplineType'):?>
          <td><button type="button" value="<?=$id?>" class="btn btn-primary show_element" data-bs-toggle="modal" data-bs-target="#dictDisciplineExternalId"> Открыть всю таблицу</button></td>
